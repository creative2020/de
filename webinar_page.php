    ...
    <div id="contact">
      <form action="http://freshaircreatives.com/forms/process.php" method="post">
        <input type="hidden" name="form_tools_form_id" value="5" />
          <div id="week">
            <div class="week">
              Week 1 <input type="checkbox" name="week1" value="Week 1" id="week_1" />
            </div>
            <div class="week">
              Week 2 <input type="checkbox" name="week2" value="Week 2" id="week_2" />
            </div>
            <div class="week">
              Week 3 <input type="checkbox" name="week3" value="Week 3" id="week_3" />
            </div>
            <div class="week">
              Week 4 <input type="checkbox" name="week4" value="Week 4" id="week_4" />
            </div>
            <div class="clear"></div>
          </div>
          <div class="clear"></div>
